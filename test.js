...
// Don't try this at home, object keys are nonsensical.
test('ill-advised object keys', function (t) {
  t.plan(3)
  ...
  db.get(b, { asBuffer: false }, function (err, value) {
    ...
    // This weirdness is explained by:
    t.is(ltgt.compare(a, b), 0, 'objects are equal according to ltgt')
  })
})
